...
public class DlgLogin extends javax.swing.JDialog{
    DlgConfBanco dlgCB = new DlgConfBanco(this,true); // Cria uma extenção para se comunicar com as configurações do banco
    public static Connection conexao; //Conexão com o banco
    public DlgLogin(java.awt.Frame parent, boolean modal) { //construtor DlgLogin
        try {
            UIManager.setLookAndFeel("com.sun.java.swing.plaf.windows.WindowsLookAndFeel"); //responsavel por modificar o grafico para windows
    ...
    private void initComponents() {
        ...
        jLabel3.setText("CNPJ xx.xxx.xxx.xxxx-xx");

        jLabel4.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        jLabel4.setText("Transistor Soluções em Informática");
    ...
    private void btnEntrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEntrarActionPerformed
        if (identificaBanco()&&identificaUsuario()) {
            Janela janela = new Janela();//Cria uma Janela principal
            janela.setVisible(true);//Torna a janela principal visivel
    ...
    private boolean identificaBanco(){ //Faz a identificação do brnco e a conexão
