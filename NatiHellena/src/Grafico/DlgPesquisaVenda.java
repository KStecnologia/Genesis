...
public class DlgPesquisaVenda extends javax.swing.JDialog {
    ...
    private void btnGerarPDFActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGerarPDFActionPerformed
        ...
        try {
            PdfWriter.getInstance(document, new FileOutputStream("C:\\genesis\\NatiHellena\\PDF\\TabelaDeVendas.pdf"));
            ...
            Runtime.getRuntime().exec(new String[]{"cmd.exe", "/c", "start", "C:\\genesis\\NatiHellena\\PDF\\TabelaDeVendas.pdf"});
